...
public class EvaluateRanks {
	...
	public static void evaluateFilm(String to, List<String> instanceList){
		...
		//goldenRankList.get(goldenRankList.indexOf(new Rank("Holy_Man")));
		String format = "%s%-30s";
		...
		for (int i= 0; i < size; i++) {
			...
			s1Total[i] = Round.round(s1Total[i]/instanceListSize,2);
			s2Total[i] = Round.round(s2Total[i]/instanceListSize,2);
		}
	...
	public static void evaluateMuseum(String to, List<Instance> instanceList){
