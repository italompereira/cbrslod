 ...
 * https://github.com/learning-layers/SocRec/blob/master/code/solr-resource-recommender-framework/
 * src/main/java/at/knowcenter/recommender/solrpowered/evaluation/metrics/NDCG.java
 */
public class NDCG {
	...
	public static double calculateNDCG(List<String> realData, List<String> predictionData, int k) {
		...
		for (int i = 0; i < k; i++) {
			...
			int itemRelevance = 1;
			if (!realData.subList(0, k).contains(predictedItem))
				itemRelevance = 0;
